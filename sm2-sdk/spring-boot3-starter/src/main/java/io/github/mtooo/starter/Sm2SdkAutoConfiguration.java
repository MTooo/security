...
import io.github.mtooo.core.crypto.impl.HutoolSm2KeyExchange;
import io.github.mtooo.core.crypto.impl.HutoolSm4Crypto;
...
import io.github.mtooo.core.session.impl.RedisSessionStore;
...
public class Sm2SdkAutoConfiguration {
     ...
     * Redis 相关的 Bean 定义。
     *
     * <p>使用独立的内部配置类，确保 {@link StringRedisTemplate} 不存在时
     * 整个外部类可以正常加载。
     */
    @AutoConfiguration
