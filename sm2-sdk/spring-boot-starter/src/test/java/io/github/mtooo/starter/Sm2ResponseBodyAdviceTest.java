...
class Sm2ResponseBodyAdviceTest {
    ...
    @Test
    @DisplayName("Should serialize non-String body via Jackson and encrypt the result")
    void testSerializesAndEncryptsNonStringBody() {
        ...
        assertNull(result);
        assertEquals("encrypted-int", new String(responseBodyStream.toByteArray(), StandardCharsets.UTF_8));
    ...
    void testEncryptsResponseSuccessfully() {
        ...
        assertNull(result);
        assertEquals("encrypted-base64", new String(responseBodyStream.toByteArray(), StandardCharsets.UTF_8));
    ...
    void testEncryptsResponseWithMethodLevelAnnotation() {
        ...
        assertNull(result);
        assertEquals("encrypted", new String(responseBodyStream.toByteArray(), StandardCharsets.UTF_8));
